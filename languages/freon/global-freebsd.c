...
// Tested with gcc 2.96 on FreeBSD 4.0

// macros to define absolute symbols in the coldstore
#define STARTABS asm(".section .absolute");asm(".globl _4Mmap$end"); asm(".type _4Mmap$end,@object"); asm(".size _4Mmap$end,0"); asm(".set _4Mmap$end,0x10000000"); asm(".globl _4Mmap$header"); asm(".type _4Mmap$header,@object"); asm(".set _4Mmap$header,_4Mmap$end");
...
//OBJECT(_5iPool$all, 4);		// coldstore's iPool set
