// pyc.cc: bootstrap routine for pyc interpreter
// Copyright (C) 2001, Ryan Daum
// see LICENSE (MD5 d7a11a4148f3858e544bf89cdde91727) for terms

static char *id __attribute__((unused))="$Id: pyc.cc,v 1.8 2001/06/05 16:30:41 opiate Exp $";
...
AutoLoad autoload_elfs[] = {
    ...
    {"../mud/mud.so", Elf::COLDSTORE, NULL},
    {"./pyc.so", Elf::COLDSTORE, NULL},
    {NULL}
};
