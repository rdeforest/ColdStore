// mud.cc: cold loader for mud
// Copyright (C) 2001, Ryan Daum
// see LICENSE (MD5 d7a11a4148f3858e544bf89cdde91727) for terms

static char *id __attribute__((unused))="$Id: mud.cc,v 1.11 2001/08/10 21:16:48 opiate Exp $";
...
AutoLoad autoload_elfs[] = {
    {"libcold.so", Elf::COLDSTORE, NULL},
    {"libcold_toolkit.so", Elf::COLDSTORE, NULL},
    {"chatter.so", Elf::COLDSTORE, NULL},
    {"mud.so", Elf::COLDSTORE, NULL},
    {"mudtest.so", Elf::COLDSTORE, NULL},
    {NULL}
};
